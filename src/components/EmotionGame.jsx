...
// const questions = [
//   {
//     image: happyface, // Example happy face
//     choices: ["Happy", "Sad", "Angry"],
//     answer: "Happy",
//   },
//   {
//     image: sadface, // Example sad face
...
// export default function EmotionGame({ onFinish }) {
...
//     else onFinish(score + (choice === questions[current].answer ? 1 : 0), questions.length);
//   }

//   return (
//     <div className="flex flex-col items-center justify-center h-screen bg-yellow-50">
//       <h2 className="text-2xl font-semibold mb-4">Which emotion is this?</h2>
//       <img
//         src={questions[current].image}
//         alt="Emotion"
//         className="w-40 h-40 object-contain mb-6 border-4 border-gray-300 rounded-full"
//       />
...
//             className="px-5 py-2 bg-yellow-400 rounded shadow hover:bg-yellow-500"
//           >
//             {choice}
//           </button>
//         ))}
